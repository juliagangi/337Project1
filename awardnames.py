...
def build_human_readable(data):
    ...
    for award in award_names:
        ...
        print('Presenters: '+presenters+'')import json
import numpy as np
import csv
import spacy
from spacy import displacy
...
awards = [['best supporting actor in a drama', 'best supporting actor, drama'], ['best supporting actor, motion picture', 'best supporting actor in a motion picture'], ['best supporting actress tv series, miniseries, or tv movie'], ['best actress in a mini-series/tv movie', 'best actress in a mini-series, tv movie'], ['best actor for tv drama', 'best tv drama actor', 'best actor in tv drama'], ['best original song award'], ['best original song category, the golden globe'], ['best actor in a miniseries/tv movie', 'best tv movie or miniseries actor'], ['best actress in a motion picture comedy or musical', 'best actress motion picture comedy or musical'], ['best supporting actor in a tv show, miniseries or tv movie award'], ['best supporting actress in a motion picture', 'best supporting actress motion picture', 'best supporting actress for motion picture'], ['best screenplay in a motion picture', 'best motion picture screenplay', 'best screenplay, motion picture', 'best screenplay - motion picture', 'best screenplay for a motion picture'], ['best actor tv series - comedy or musical'], ['best actress, tv drama', 'best tv drama actress', 'best actress in a tv drama', 'best drama tv actress'], ['best actress in a tv series, drama', 'best actress in a tv series - drama'], ['best animated feature film'], ['best actress in a tv comedy or musical', 'best actress in a tv comedy/musical'], ['best director for motion picture', 'best director for a motion picture', 'best director of a motion picture', 'best director - motion picture'], ['best actor in a motion picture comedy/musical', 'best actor in a motion picture, comedy/musical'], ['best actor, comedy/musical', 'best actor in comedy/musical', 'best actor, musical or comedy', 'best actor in comedy or musical'], ['best motion picture, comedy or musical', 'best motion picture, comedy/musical', 'best motion picture - comedy/musical', 'best motion picture comedy or musical', 'best motion picture comedy/musical'], ['best actress in a motion picture drama', 'best actress for motion picture- drama', 'best actress, motion picture/drama', 'best actress in a motion picture for drama', 'best actress for a motion picture drama'], ['best actor in a motion picture drama', 'best actor, motion picture drama', 'best actor in motion picture drama'], ['best motion picture drama', 'best motion picture - drama', 'best motion picture in drama'], ['best actor, drama: golden globe for film']]
...
def get_keywords(the_awards):
    keywords = the_keywords(the_awards)
    new_awards = []
...
def plus(some_awards):
    the_awards = get_keywords(some_awards)
    first = ""
    second = ""
    third = ""
...
def build_json(data):
    ...
    return_dict["hosts"] = get_hosts()
    award_names = get_awards(data)
    #award_names = [['best supporting actor in a drama', 'best supporting actor, drama'], ['best supporting actor, motion picture', 'best supporting actor in a motion picture'], ['best supporting actress tv series, miniseries, or tv movie'], ['best actress in a mini-series/tv movie', 'best actress in a mini-series, tv movie'], ['best actor for tv drama', 'best tv drama actor', 'best actor in tv drama'], ['best original song award'], ['best original song category, the golden globe'], ['best actor in a miniseries/tv movie', 'best tv movie or miniseries actor'], ['best actress in a motion picture comedy or musical', 'best actress motion picture comedy or musical'], ['best supporting actor in a tv show, miniseries or tv movie award'], ['best supporting actress in a motion picture', 'best supporting actress motion picture', 'best supporting actress for motion picture'], ['best screenplay in a motion picture', 'best motion picture screenplay', 'best screenplay, motion picture', 'best screenplay - motion picture', 'best screenplay for a motion picture'], ['best actor tv series - comedy or musical'], ['best actress, tv drama', 'best tv drama actress', 'best actress in a tv drama', 'best drama tv actress'], ['best actress in a tv series, drama', 'best actress in a tv series - drama'], ['best animated feature film'], ['best actress in a tv comedy or musical', 'best actress in a tv comedy/musical'], ['best director for motion picture', 'best director for a motion picture', 'best director of a motion picture', 'best director - motion picture'], ['best actor in a motion picture comedy/musical', 'best actor in a motion picture, comedy/musical'], ['best actor, comedy/musical', 'best actor in comedy/musical', 'best actor, musical or comedy', 'best actor in comedy or musical'], ['best motion picture, comedy or musical', 'best motion picture, comedy/musical', 'best motion picture - comedy/musical', 'best motion picture comedy or musical', 'best motion picture comedy/musical'], ['best actress in a motion picture drama', 'best actress for motion picture- drama', 'best actress, motion picture/drama', 'best actress in a motion picture for drama', 'best actress for a motion picture drama'], ['best actor in a motion picture drama', 'best actor, motion picture drama', 'best actor in motion picture drama'], ['best motion picture drama', 'best motion picture - drama', 'best motion picture in drama'], ['best actor, drama: golden globe for film']]
    save_awards = award_names
    noms_award_names = plus(award_names)
    award_names = save_awards

    counter = 0
    for award in noms_award_names:
        #print(award)
        curr_dict = {}
        nominees = get_nominees(award, the_movies,the_shows)
        curr_dict["nominees:"] = nominees
...
#find_name_or_movie("alan arkin")
#find_name_or_movie("leonardo dicaprio")
...
def duplicate_lastnames():
    duplicates = []
    lastnamedict = {"taylor swift": ["taylor swift", "swift"]}
    for person in persondict:
        splitname = person.split()
        lastname = splitname[-1]
        if lastname in lastnamedict:
            ...
            lastnamedict[lastname] = lastname
    return duplicates
...
#noms_input = [['best supporting actor in a drama', 'best supporting actor, drama', ['supporting actor', 'drama']], ['best supporting actor, motion picture', 'best supporting actor in a motion picture', ['supporting actor', 'motion picture']], ['best supporting actress tv series, miniseries, or tv movie', ['supporting actress', 'tv series miniseries movie']], ['best actress in a mini-series/tv movie', 'best actress in a mini-series, tv movie', ['actress', 'miniseries tv movie']], ['best actor for tv drama', 'best tv drama actor', 'best actor in tv drama', ['actor', 'tv drama']], ['best original song award', ['original song']], ['best original song category, the golden globe', ['original song']], ['best actor in a miniseries/tv movie', 'best tv movie or miniseries actor', ['actor', 'miniseries tv movie']], ['best actress in a motion picture comedy or musical', 'best actress motion picture comedy or musical', ['actress', 'motion picture', 'comedy musical']], ['best supporting actor in a tv show, miniseries or tv movie award', ['supporting actor', 'tv show miniseries movie']], ['best supporting actress in a motion picture', 'best supporting actress motion picture', 'best supporting actress for motion picture', ['supporting actress', 'motion picture']], ['best screenplay in a motion picture', 'best motion picture screenplay', 'best screenplay, motion picture', 'best screenplay - motion picture', 'best screenplay for a motion picture', ['screenplay']], ['best actor tv series - comedy or musical', ['actor', 'tv series comedy musical']], ['best actress, tv drama', 'best tv drama actress', 'best actress in a tv drama', 'best drama tv actress', ['actress', 'tv drama']], ['best actress in a tv series, drama', 'best actress in a tv series - drama', ['actress', 'tv series drama']], ['best animated feature film', ['feature film']], ['best actress in a tv comedy or musical', 'best actress in a tv comedy/musical', ['actress', 'tv comedy musical']], ['best director for motion picture', 'best director for a motion picture', 'best director of a motion picture', 'best director - motion picture', ['director']], ['best actor in a motion picture comedy/musical', 'best actor in a motion picture, comedy/musical', ['actor', 'motion picture', 'comedy musical']], ['best actor, comedy/musical', 'best actor in comedy/musical', 'best actor, musical or comedy', 'best actor in comedy or musical', ['actor', 'comedy musical']], ['best motion picture, comedy or musical', 'best motion picture, comedy/musical', 'best motion picture - comedy/musical', 'best motion picture comedy or musical', 'best motion picture comedy/musical', ['motion picture', 'comedy musical']], ['best actress in a motion picture drama', 'best actress for motion picture- drama', 'best actress, motion picture/drama', 'best actress in a motion picture for drama', 'best actress for a motion picture drama', ['actress', 'motion picture', 'drama']], ['best actor in a motion picture drama', 'best actor, motion picture drama', 'best actor in motion picture drama', ['actor', 'motion picture', 'drama']], ['best motion picture drama', 'best motion picture - drama', 'best motion picture in drama', ['motion picture', 'drama']], ['best actor, drama: golden globe for film', ['actor', 'drama film']]]
awards = plus(awards)
#print(awards)
for award in awards:
    get_nominees(award, the_movies, the_shows)        print('Winner: '+winner+'\n')
    bestdressed = best_dressed(data)
    worstdressed = worst_dressed(data)
    print('Best Dressed: '+bestdressed+'')
    print('Worst Dressed: '+worstdressed+'')
...
#print(awards)
for award in awards:
    get_nominees(award, the_movies, the_shows)def combine_nominees(awards):
    returndict = {}
    for award in awards:
        get_nominees(award,the_movies,the_shows)
        nomarray = get_presenters(award)
