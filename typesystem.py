...
#text1 = NER(raw_text)
#{"hosts": [...,...], "award data": {"award_name": {"nominees": [...,...], "winner": [...]}, "award_name": {...}}}
...
def build_frame(ceremony):
    ...
    award_names = get_award_names(ceremony)
...
def get_hosts(ceremony):
    return ["host"]

def get_award_names(ceremony):
...
def nominees_given_awards(award, movielist):
    award = award.lower()
    vote_dict = {}
    for element in data:
        tweet = (element['text'])
